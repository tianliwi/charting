var Lib = function(t, e) {
    ...
    class o {
        ...
        _lines = [];
        constructor(t) {
            this.legendHandler = this.legendHandler.bind(this), this.handler = t, this.ohlcEnabled = !1, this.percentEnabled = !1, this.linesEnabled = !1, this.colorBasedOnCandle = !1, this.div = document.createElement("div"), this.div.classList.add("legend"), this.div.style.maxWidth = 100 * t.scale.width - 8 + "vw", this.div.style.display = "none", this.text = document.createElement("span"), this.text.style.lineHeight = "1.8", this.candle = document.createElement("div"), this.div.appendChild(this.text), this.div.appendChild(this.candle), t.div.appendChild(this.div), t.chart.subscribeCrosshairMove(this.legendHandler)
        }
        toJSON() {
            const {
                _lines: t,
        ...
        makeSeriesRow(t, e) {
            ...
            })), l.appendChild(h), a.appendChild(l), n.appendChild(r), n.appendChild(a), this.div.appendChild(n);
            const c = e.options().baseLineColor;
            this._lines.push({
                name: t,
                div: r,
                row: n,
    ...
    class c extends d {
        ...
        _drawEndCircle(t, e, i) {
            ...
            t.context.strokeStyle = "white";
            t.context.fillStyle = "black";
            t.context.beginPath();
            t.context.arc(e, i, 4, 0, 2 * Math.PI);
            t.context.stroke();
            t.context.fill();
        }
    }
    ...
    class y {
        ...
        _onClick(t) {
            ...
            if (e)
                if (null == this._activeDrawing) {
                    if (null == this._drawingType) return;
                    this._activeDrawing = new this._drawingType(e, e), this._series.attachPrimitive(this._activeDrawing), this._drawingType == w && this._onClick(t)
                } else {
                    if (this._drawings.push(this._activeDrawing), this.stopDrawing(), !this._finishDrawingCallback) return;
        ...
        draw(t) {
            t.useBitmapCoordinateSpace((t => {
                ...
                if (i) {
                    ...
                    const yMid = (i.y1 + i.y2) / 2;
                    const y79 = i.y2 - (i.y2 - i.y1) * 0.79
                    const y62 = i.y2 - (i.y2 - i.y1) * 0.62
                    ...
                    e.font = '10px Arial';
                    e.fillStyle = 'white';
                    e.fillText('1', i.x2 + 10, i.y1);
                    e.fillText('0', i.x2 + 10, i.y2);
                    e.fillText('0.79', i.x2 + 10, y79);
                    e.fillText('0.62', i.x2 + 10, y62);
        
                    e.fillStyle = 'red';
                    e.fillText('0.5', i.x2 + 10, yMid);
        
                    // If the element is hovered, draw end circles at the ends of the lines
                    if (this._hovered) {
    ...
    class fibdraw extends m {
        constructor(t) {
            super(t)
        }
        renderer() {
            return new fibdrawcore(this._p1, this._p2, this._source._options, this._source.hovered)
        }
    }
    class sddrawcore extends c {
        constructor(t, e, i, s) {
            super(t, e, i, s)
        }
        draw(t) {
            t.useBitmapCoordinateSpace((t => {
                ...
                if (i) {
                    ...
                    const ym1 = i.y2 + (i.y2 - i.y1)
                    const ym15 = i.y2 + (i.y2 - i.y1) * 1.5
                    const ym2 = i.y2 + (i.y2 - i.y1)*2
                    const ym25 = i.y2 + (i.y2 - i.y1) * 2.5
                    const ym35 = i.y2 + (i.y2 - i.y1)*3.5
                    const ym4 = i.y2 + (i.y2 - i.y1) * 4
                    ...
                    const labelX = Math.max(i.x1, i.x2) + 10;
                    e.font = '10px Arial';
                    e.fillStyle = 'green';
                    e.fillText('-1', labelX, ym1);
                    e.fillText('-1.5', labelX, ym15);

                    e.fillStyle = 'red';
                    e.fillText('-2', labelX, ym2);
                    e.fillText('-2.5', labelX, ym25);
                    e.fillText('-4', labelX, ym4);

                    e.fillStyle = 'white';
                    e.fillText('1', labelX, i.y1);
                    e.fillText('0', labelX, i.y2);
                    e.fillText('-3.5', labelX, ym35);
    ...
    class sddraw extends m {
        constructor(t) {
            super(t)
        }
        renderer() {
            return new sddrawcore(this._p1, this._p2, this._source._options, this._source.hovered)
        }
    }
    class f extends h {
        _paneViews = [];
...
class D extends c {
    ...
    class fib extends f {
        _type = "Fib";
        constructor(t, e, i) {
            super(t, e, i), this._paneViews = [new fibdraw(this)]
        }
        _moveToState(t) {
            switch (t) {
                case l.NONE:
    ...
    class sd extends f {
        _type = "SD";
        constructor(t, e, i) {
            super(t, e, i), this._paneViews = [new sddraw(this)]
        }
        _moveToState(t) {
            switch (t) {
                case l.NONE:
    ...
    class P {
        ...
        _makeToolBox() {
            ...
            this.buttons.push(this._makeToolBoxElement(L, "KeyB", P.BOX_SVG));
            this.buttons.push(this._makeToolBoxElement(B, "KeyV", P.VERT_SVG, !0));
        ...
        saveDrawings = () => {
            const t = [];
            for (const e of this._drawingTool.drawings) t.push({
                type: e._type,
                points: e.points,
                options: e._options
            });
        ...
        loadDrawings(t) {
            t.forEach((t => {
                switch (t.type) {
                    case "Box":
                        this._drawingTool.addNewDrawing(new L(t.points[0], t.points[1], t.options));
                        break;
                    case "TrendLine":
                        this._drawingTool.addNewDrawing(new C(t.points[0], t.points[1], t.options));
                        break;
                    case "HorizontalLine":
                        this._drawingTool.addNewDrawing(new w(t.points[0], t.options));
                        break;
                    case "RayLine":
                        this._drawingTool.addNewDrawing(new M(t.points[0], t.options));
                        break;
                    case "VerticalLine":
                        this._drawingTool.addNewDrawing(new B(t.points[0], t.options))
                }
            }))
        }
    }
        ...
        updateMenuItems(t) {
            this.div.innerHTML = "", t.forEach((t => {
                ...
                e.elem.addEventListener("click", (() => {
                    this.widget.elem.innerText = e.elem.innerText + " ↓", window.callbackFunction(`${this.callbackName}_~_${e.elem.innerText}`), this.div.style.display = "none", this.isOpen = !1
    ...
    class V {
        ...
        makeSwitcher(t, e, i, s = "left") {
            ...
            const r = {
                ...
                onItemClicked: t => {
                    t != n && (n.classList.remove("active-switcher-button"), t.classList.add("active-switcher-button"), n = t, window.callbackFunction(`${r.callbackName}_~_${t.innerText}`))
                }
            };
    ...
    return t.Box = L, t.Handler = class {
        ...
        createToolBox() {
            this.toolBox = new P(this.id, this.chart, this.series, this.commandFunctions), this.div.appendChild(this.toolBox.div)
        }
        createTopBar() {
    ...
    }, t.ToolBox = P, t.TopBar = V, t.TrendLine = C, t.VerticalLine = B, t.globalParamInit = s, t.paneStyleDefault = i, t.setCursor = t => {
        t && (window.cursor = t), document.body.style.cursor = window.cursor
    }, t
}({}, LightweightCharts);